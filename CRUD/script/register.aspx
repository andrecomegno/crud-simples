                ...
                <tr>
                    ...
                    <td class="td-center">
                        <asp:Panel ID="panel_one" runat="server" CssClass="style-panel-one">
                            ...
                            <asp:DropDownList CssClass="style-phone-type" runat="server" ClientIDMode="AutoID" TabIndex="5" ID="phone_type">
                        ...
                        <asp:Panel ID="panel_three" runat="server" CssClass="style-panel-three">
                            <br />
                            <asp:TextBox CssClass="style-txt-zip" placeholder="CEP" runat="server" MaxLength="8" TabIndex="10" ID="input_zip"></asp:TextBox>
                            <asp:Button CssClass="style-bt-search" runat="server" TabIndex="11" Text="Buscar" ID="bt_search" />
                            ...
                            <br />
                            <asp:TextBox CssClass="style-txt-address" placeholder="Endereço" runat="server" MaxLength="250" TabIndex="13" ID="txt_address"></asp:TextBox>
                            <asp:TextBox CssClass="style-txt-address-number" placeholder="Número" runat="server" MaxLength="6" TabIndex="14" ID="txt_address_number"></asp:TextBox>
                            <asp:TextBox CssClass="style-txt-neighborhood" placeholder="Bairro" runat="server" MaxLength="250" TabIndex="15" ID="txt_neighborhood"></asp:TextBox>
                            <asp:TextBox CssClass="style-txt-city" placeholder="Cidade" runat="server" MaxLength="250" TabIndex="16" ID="txt_city"></asp:TextBox>
                            <asp:TextBox CssClass="style-txt-state" placeholder="Estado" runat="server" MaxLength="2" TabIndex="17" ID="txt_state"></asp:TextBox>
                            <asp:Button CssClass="style-bt-cancel" placeholder="Bairro" runat="server" TabIndex="18" Text="Cancelar" ID="bt_cancel" PostBackUrl="~/script/login.aspx" Font-Bold="True" Font-Size="Medium" />
                            <asp:Button CssClass="style-bt-save" placeholder="Bairro" runat="server" TabIndex="19" Text="Salvar" ID="bt_save" Font-Bold="True" Font-Size="Medium" />
                        </asp:Panel>
                    </td>
